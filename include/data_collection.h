...
typedef struct {
   ...
   unsigned version_id : 16;                  /* Version 29 : NOTAG  */
} B3_L1;
...
typedef struct {
   ...
   unsigned cartridge_18 : 1;                 /* Cartridge 18 on telescope */
   unsigned cartridge_17 : 1;                 /* Cartridge 17 on telescope */
   unsigned cartridge_16 : 1;                 /* Cartridge 16 on telescope */
   unsigned cartridge_15 : 1;                 /* Cartridge 15 on telescope */
   unsigned cartridge_14 : 1;                 /* Cartridge 14 on telescope */
   unsigned cartridge_13 : 1;                 /* Cartridge 13 on telescope */
   unsigned cartridge_12 : 1;                 /* Cartridge 12 on telescope */
   unsigned cartridge_11 : 1;                 /* Cartridge 11 on telescope */
   unsigned cartridge_10 : 1;                 /* Cartridge 10 on telescope */
   unsigned apogee_gc_unplugged : 1;          /* APOGEE gang connector unplugged */
   unsigned apogee_gc_at_cart : 1;            /* APOGEE gang connector plugged into a cartridge */
   unsigned apogee_gc_at_stow : 1;            /* APOGEE gang connector at stow position (any port in podium) */
   unsigned apogee_gc_at_dense : 1;           /* APOGEE gang connector plugged into dense calibration port */
   unsigned apogee_gc_at_sparse : 1;          /* APOGEE gang connector at sparse calibration port */
   unsigned apogee_gc_at_1m : 1;              /* APOGEE gang connector at 1m port */
...
typedef struct {
   ...
   unsigned apogee_gc_at_stow_sw : 1;         /* Status switch for APOGEE gang connector in stow position  any port */
   unsigned apogee_gc_at_cart_sw : 1;         /* Status switch for APOGEE gang connector plugged into cartridge */
   unsigned apogee_fgc_dense_sw : 1;          /* Status switch for APOGEE gang connector in dense port */
   unsigned apogee_fgc_sparse_sw : 1;         /* Status switch for APOGEE gang connector in sparse port */
   unsigned apogee_fgc_1m_sw : 1;             /* Status switch for APOGEE gang connector in 1m port. */
...
typedef struct {
   ...
   unsigned sad_latch1_cls : 1;               /* Saddle latches open */
...
typedef struct {
   ...
   unsigned az_near_dimm : 1;                 /* Switch defines azimuth range near DIMM */
...
typedef struct {
   unsigned umbilical_dn : 1;                 /* Umbilical is below 480 */
   unsigned alt_pos_gt_neg_2 : 1;             /* alt > -0.2 */
   unsigned alt_pos_lt_0_2 : 1;               /* alt < 0.2 */
   unsigned alt_position_gt_83_5 : 1;         /* alt > 83.5 */
   unsigned alt_position_gt_15_5 : 1;         /* alt > 15.5 */
   unsigned alt_position_gt_15_0 : 1;         /* alt > 15.0 */
   unsigned alt_position_lt_18_5 : 1;         /* alt < 18.5 */
   unsigned alt_position_gt_0_8 : 1;          /* alt > 0.8 */
   unsigned alt_position_gt_19_5 : 1;         /* alt > 19.5 */
   unsigned alt_position_gt_0_50 : 1;         /* alt > 0.50 */
   unsigned alt_position_gt_89_8 : 1;         /* alt > 89.8 */
   unsigned alt_position_lt_91_0 : 1;         /* alt < 91.0 */
   unsigned alt_position_lt_90_29 : 1;        /* alt < 90.29 */
   unsigned alt_position_lt_90_2 : 1;         /* alt < 90.2 */
   unsigned alt_position_gt_89_75 : 1;        /* alt > 89.75 */
   unsigned alt_position_lt_90_15 : 1;        /* alt < 90.15 */
   ...
   unsigned lift_height_gt_h_cartridge_mount : 1; /* Instrument lift distance is >= 21.95 */
   unsigned lift_force_gt_f_cartridge_mount : 1; /* Instrument lift force is > 1400lb */
} I10_L0;
...
typedef struct {
   ...
   unsigned viktory_guardpin : 1;             /* Extend pin to protect gang connector in cartridge from Lindy cart */
 ...
 */
   ...
   static char plcVersion[] = "Version 29 : NOTAG";
#endif
/*
